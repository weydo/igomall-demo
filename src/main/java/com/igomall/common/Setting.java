...
public class Setting implements Serializable {
	 ...
	 * 允许注册类型
	 */
	private RegisterType[] allowedRegisterTypes;
	...
	public RegisterType[] getAllowedRegisterTypes() {
	 ...
	 *            允许注册类型
	 */
	public void setAllowedRegisterTypes(RegisterType[] allowedRegisterTypes) {
